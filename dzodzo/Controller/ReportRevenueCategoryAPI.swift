//
//  ReportRevenueCategoryAPI.swift
//  dzodzo
//
...
class ReportRevenueCategoryAPI {

    static func getData(pstartdate: String, penddate: String, success: @escaping ([ReportRevenueCategory])-> Void) {
        ...
        let componentsGetPost = URLComponents(scheme: "https", host: "dzodzo.com.vn", path: "/a/api", queryItems: [
            ...
            URLQueryItem(name: "Service", value: "crud_search_report_revenue_category_service"),
        ...
        print("URL ReportRevenueCategory: \(urlGetPos)")
        ...
        Alamofire.request(urlRequest).responseJSON{ response in
            ...
            var model = [ReportRevenueCategory]()
            for dic in getposAPI {
                model.append(ReportRevenueCategory(dic))
            }
            success(model)
            print("DATA: \(model)")
