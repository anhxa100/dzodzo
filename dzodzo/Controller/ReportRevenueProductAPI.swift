...
class ReportRevenueProductAPI {
    static func getRevenueTotalWithChart(pstartdate: String, penddate: String, success: @escaping ([ReportRevenueProduct])-> Void) {
        ...
        let componentsGetPost = URLComponents(scheme: "https", host: "dzodzo.com.vn", path: "/a/api", queryItems: [
            ...
            URLQueryItem(name: "Service", value: "chart_report_revenue_item"),
        ...
        Alamofire.request(urlRequest).responseJSON{ response in
            ...
            var model = [ReportRevenueProduct]()
            for dic in getposAPI {
                model.append(ReportRevenueProduct(dic))
            }
            success(model)
    ...
    static func getRevenueTotal(pstartdate: String, penddate: String, success: @escaping ([ReportRevenueProduct])-> Void) {
        ...
        let componentsGetPost = URLComponents(scheme: "https", host: "dzodzo.com.vn", path: "/a/api", queryItems: [
            URLQueryItem(name: "ServiceType", value: "query"),
            URLQueryItem(name: "Service", value: "crud_search_report_revenue_item_service"),
            URLQueryItem(name: "Provider", value: "default"),
