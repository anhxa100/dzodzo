...
extension ReportRevenuePayTypeVC : CalendarDateRangePickerViewControllerDelegate {
    ...
    func didTapDoneWithDateRange(startDate: Date!, endDate: Date!) {
        ...
        ReportRevenuePayTypeAPI.getData(pstartdate: startDay, penddate: endDay, success: {[weak self] chooseData in
            self?.paytypeArray = chooseData
        })
